...
export default function Page() {
  ...
  const [selectedSessionId, setSelectedSessionId] = useState('verdant-keys');
  ...
  function handleRoleChange(nextRole: Role) {
    ...
    if (nextRole === 'operator') {
      ...
      setSelectedSessionId(getOperatorDefaultSession());
      return;
    }

    setActiveNav('overview');
    setSelectedSessionId('verdant-keys');
  }
      ...
      <div className={styles.frame}>
        ...
        <main className={styles.main} id="main-content">
          ...
          {role === 'operator' && selectedSessionId === 'assigned-list' ? (
            <section className={styles.emptyState} aria-labelledby="assigned-sessions-title">
              <div>
              ...
              <div className={styles.emptyActions}>
                ...
                <button className={styles.secondaryButton} onClick={() => handleRoleChange('admin')} type="button">
                  Switch to admin overview
                </button>
              </div>
            </section>
