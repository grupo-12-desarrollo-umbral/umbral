/**
 * THROWAWAY PROTOTYPE COPY of `src/components/active-question-stage.tsx`.
 *
 * The operative-clue UI prototype (`app/(app)/operative-clue-prototype.tsx`) mounts
 * this as its live trivia backdrop so the operative-clue variants can be judged
 * butting up against the real question stage — without coupling the production
 * component to prototype tweaks. Delete this file when the prototype is folded in.
 */
