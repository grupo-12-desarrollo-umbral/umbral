...
public interface IErrorMetadata
{
    ...
    /// (user ids, team ids, external identity ids). An exception opts in by overriding this with
    /// a curated, identifier-free sentence when its explanation is safe to expose.
    /// </summary>
