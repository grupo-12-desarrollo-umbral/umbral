...
// Real subject wrapped by ParticipantTeamSelfJoinAuthorizationProxy (the registered IRequestHandler).
public sealed class JoinTeamAsParticipantCommandHandler
{
    ...
    public JoinTeamAsParticipantCommandHandler(
    ...
    public async Task<Guid> Handle(JoinTeamAsParticipantCommand command, CancellationToken cancellationToken)
    {
