...
public sealed class ErrorCodeContractTests
{
    ...
    private static readonly IReadOnlyDictionary<string, string> ExpectedErrorCodes =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["MissionCannotBeReactivatedException"] = "mission-cannot-be-reactivated",
            ...
            ["MissionNotEditableWhileInactiveException"] = "mission-not-editable-while-inactive",
            ...
            ["TargetQrCodeMustBeUniqueWithinMissionException"] = "target-qr-code-must-be-unique-within-mission",
