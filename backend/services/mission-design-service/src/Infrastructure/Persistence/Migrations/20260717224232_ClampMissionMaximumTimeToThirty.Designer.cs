...
namespace umbral_backend.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260717224232_ClampMissionMaximumTimeToThirty")]
    partial class ClampMissionMaximumTimeToThirty
    {
        /// <inheritdoc />
                                    ...
                                    b2.OwnsMany("umbral_backend.Domain.Entities.Target", "_targets", b3 =>
                                        {
                                            ...
                                            b3.OwnsOne("umbral_backend.Domain.ValueObjects.GeoCoordinates", "Coordinates", b4 =>
                                                {
                                                    b4.Property<int>("TargetId")
                                                        .HasColumnType("integer");
                                                    ...
                                                    b4.ToTable("MissionTargets");

                                                    b4.WithOwner()
                                                        .HasForeignKey("TargetId");
                                                });

                                            b3.OwnsOne("umbral_backend.Domain.ValueObjects.ScoreValue", "Score", b4 =>
                                                {
                                                    b4.Property<int>("TargetId")
                                                        .HasColumnType("integer");

                                                    b4.Property<int>("Points")
                                                        .HasColumnType("integer")
                                                        .HasColumnName("Score");
