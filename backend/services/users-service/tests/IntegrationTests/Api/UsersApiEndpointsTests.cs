...
public sealed class UsersApiEndpointsTests : IAsyncLifetime
{
    private readonly PostgreSqlFixture _fixture;
    private UsersApiWebApplicationFactory _factory = null!;
    private HttpClient _client = null!;

    public UsersApiEndpointsTests(PostgreSqlFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    {
        _factory = new UsersApiWebApplicationFactory(_fixture.ConnectionString);
