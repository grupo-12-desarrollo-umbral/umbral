...
public sealed class TeamRepositoryIntegrationTests
{
    ...
    public async Task RegisterTeam_WithDuplicateCode_ThrowsInHandlerAndDatabaseBackstopRejectsDuplicate()
    {
        ...
        // The unique index still rejects the duplicate, but the repository translates the raw 23505
        // into the domain conflict so no Npgsql/EF exception escapes into Application on a lost race.
