...
{
    private const string EnvironmentVariableName = "SCORING_MONITORING_SERVICE_CONNECTION_STRING";

    [Fact]
    public void CreateDbContext_WhenEnvironmentConnectionStringIsSet_UsesEnvironmentValue()
    {
        const string connectionString = "Host=localhost;Database=scoring_monitoring_env;Username=postgres;Password=postgres";
