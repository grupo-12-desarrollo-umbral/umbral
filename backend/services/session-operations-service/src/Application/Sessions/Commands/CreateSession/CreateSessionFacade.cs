...
public sealed class CreateSessionFacade : ICreateSessionFacade
{
    ...
    public async Task<CreateSessionResultDto> CreateAsync(
        ...
        CancellationToken cancellationToken)
    {
        ...
        var missionRuntime = await _missionRuntimeSource.GetByIdAsync(command.MissionId, cancellationToken)
            ?? throw new NotFoundException("Mission", command.MissionId);

        var sourceMissionId = GenerateMissionSourceId(command.MissionId);
