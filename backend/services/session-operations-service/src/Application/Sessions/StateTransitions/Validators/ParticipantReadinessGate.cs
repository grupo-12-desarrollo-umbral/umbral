...
/// <summary>
/// Third gate: a session can only become <see cref="SessionState.Active"/> with at least one team.
/// </summary>
public sealed class ParticipantReadinessGate : SessionTransitionValidator
{
    ...
    {
        if (context.TargetState == SessionState.Active && context.Session.Teams.Count == 0)
        {
